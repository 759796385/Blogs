  ...
  <!--<![endif]-->
    ...
    <li data-popover="true" data-content="查看博客记录." rel="popover" data-placement="right"><a href="#" data-target=".premium-menu" class="nav-header collapsed" data-toggle="collapse"><i class="fa fa-fw fa-fighter-jet"></i> 日志<i class="fa fa-collapse"></i></a></li>
        ...
        <li><ul class="legal-menu nav nav-list collapse in">
            <li class="active"><a href="MessageList"><span class="fa fa-caret-right"></span> 留言动态 <span class="label label-info">+<s:property value="#session.noread"/></span></a></li>
...
<table class="table table-hover">
  ...
  <s:iterator value="%{messages}" var="message">
    <tr>
      ...
      <td><s:property value="#message.article.title"/></td>
      <td><s:property value="#message.name" escape="true" /></td>
      <td><s:property value="#message.text" escape="true" /></td>
      <td><s:date format="yyyy-MM-dd HH:mm:ss" name="#message.date" /></td>
      <td><s:property value="#message.status"/></td>
      <td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <p class="error-text"><i class="fa fa-warning modal-icon"></i>你确定要删除这条回复吗？<br>这个删除不可恢复.</p>
        </div>
