...
<body class=" theme-blue">
  ...
  <!--<![endif]-->
    ...
    <li><ul class="dashboard-menu nav nav-list collapse in">
            ...
            <li class="active"><a href="LabelList"><span class="fa fa-caret-right"></span> 标签管理</a></li>
...
<div class="btn-toolbar list-toolbar">
    <button class="btn btn-primary" data-toggle="modal" data-target="#labmodel"><i class="fa fa-plus"></i> 添加新标签</button>
</div>
  ...
  <tbody>
    ...
    <tr>
     <td><s:property value="#label.lid"/></td>	
      <td><s:property value="#label.name"/></td>
      <td><s:property value="#label.articles.size"/></td>
      <td>
...
<div class="modal fade" id="labmodel">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="AddLabel" method="post" id="labelsf">
      <div class="modal-body">
        
          <input type="text" placeholder="请输入新标签" name="label.name" id="label.name" required="required">
      </div>
...
<div class="modal small fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <p class="error-text"><i class="fa fa-warning modal-icon"></i>你确定要删除这条标签吗？<br>这个删除不可恢复.</p>
        </div>
        <div class="modal-footer">
    ...
    <script type="text/javascript">
        function tjbtn(){
          var labels= document.getElementById("label.name");
          if(labels.value==""){
            alert("标签不能为空");  
                labels.focus();  
          }else{
