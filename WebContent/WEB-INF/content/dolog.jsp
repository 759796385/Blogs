  ...
  <!--<![endif]-->
    ...
    <li data-popover="true"  rel="popover" data-placement="right"><a href="#" data-target=".premium-menu" class="nav-header collapsed" data-toggle="collapse"><i class="fa fa-fw fa-fighter-jet"></i> 日志<i class="fa fa-collapse"></i></a></li>
        <li><ul class="premium-menu nav nav-list collapse in">
            ...
            <li  class="active"><a href="DoLog"><span class="fa fa-caret-right"></span> 操作日志</a></li>
...
<table class="table table-hover">
  ...
  <s:iterator value="%{logs}" var="log">
    <tr>
      <td><s:property value="#log.user.name"/></td>
...
<!--动态插入-->
    ...
    <script type="text/javascript">
        ...
        $(function() {
        	...
        	//dom插入
        	$(".pagination").append("<li><a href='DoLog?page="+(Number(current)-1)+"'>&laquo;</a></li>");
        	for(var i=0;i<arr.length;i++){
        		if(arr[i]!='...'){
        			$(".pagination").append("<li><a href='DoLog?page="+Number(arr[i])+"'>"+arr[i]+"</a></li>");
        		}else{
        			$(".pagination").append("<li><a href='javascript:;'>"+arr[i]+"</a></li>");
        		}
        	}
        	$(".pagination").append("<li><a href='DoLog?page="+(Number(current)+1)+"'>&raquo;</a></li>");
